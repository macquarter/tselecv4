...
export default function Certifications() {
  ...
  const certs: Cert[] = [
    ...
    },
    {
      ...
      img: 'https://images.unsplash.com/photo-1516383740770-fbcc5ccbece0?auto=format&fit=crop&w=800&q=80',
      category: 'cert',
      detail: {
    ...
    },
    {
      ...
      year: '유해물질제한',
      desc: '환경 친화 제조 공정',
      img: 'https://images.unsplash.com/photo-1532601224476-15c79f2f7a51?auto=format&fit=crop&w=800&q=80',
      category: 'cert',
      detail: {
