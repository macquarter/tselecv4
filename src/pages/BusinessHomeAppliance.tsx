            ...
            {features.map((feature, i) => (
              ...
              >
                <img
                  ...
                  data-cms-img-key={`biz.home.${feature.key}.img`}
                ...
                <div className="relative z-10 flex flex-col justify-end h-full p-8">
                  ...
                  <p className="text-gray-200 text-sm md:text-[15px] font-light leading-relaxed">{t(`bizHome.${feature.key}d`)}</p>
            ...
            <motion.div initial={{ opacity: 0, y: 40, scale: 0.96 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: 40, scale: 0.96 }} transition={{ duration: 0.4, ease: [0.16, 1, 0.3, 1] }} className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-[2rem] bg-[#0a0a0a] border border-white/10 p-8 md:p-10" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="mb-6 rounded-2xl overflow-hidden aspect-video bg-[#111] border border-white/5">
                <img loading="lazy" decoding="async"
                  ...
                  data-cms-img-key={`biz.home.${selected.key}.img`}
              ...
              <div className="mb-8">
                ...
                <ul className="space-y-2">
                  {(t(`bizHome.${selected.key}.solutions`, { returnObjects: true }) as unknown as string[]).filter((s) => typeof s === 'string' && s.trim() !== '').map((s, i) => (
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {(t(`bizHome.${selected.key}.boards`, { returnObjects: true }) as unknown as string[]).filter((b) => typeof b === 'string' && b.trim() !== '').map((b, i) => (
