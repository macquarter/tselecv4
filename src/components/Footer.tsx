    ...
    <footer className="bg-black border-t border-white/10 pt-12 md:pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-8 mb-12 md:mb-16">
          ...
          <div>
            <h4 className="text-sm font-bold tracking-widest uppercase text-white mb-6">{ftC1b}</h4>
            <ul className="space-y-4 text-sm text-gray-500">
              <li><Link to="/business/home-appliance" className="hover:text-white transition-colors">가전</Link></li>
              <li><Link to="/business/industrial" className="hover:text-white transition-colors">산업용</Link></li>
              <li><Link to="/business/medical" className="hover:text-white transition-colors">의료기기</Link></li>
              <li><Link to="/business/renewable" className="hover:text-white transition-colors">신재생에너지</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-500">
              <li><Link to="/main-controller" className="hover:text-white transition-colors">임베디드 컨트롤러</Link></li>
              <li><Link to="/display" className="hover:text-white transition-colors">HMI 솔루션</Link></li>
              <li><Link to="/others" className="hover:text-white transition-colors">주변기기 및 커스텀</Link></li>
              <li><Link to="/process" className="hover:text-white transition-colors">제조공정</Link></li>
            </ul>
          </div>
