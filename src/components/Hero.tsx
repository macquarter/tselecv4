...
export default function Hero() {
  ...
  const bgImg =
    'https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=2500&q=80';
  ...
  return (
    <section ref={containerRef} className="h-[150vh] relative bg-black">
      <div className="sticky top-0 h-screen overflow-hidden flex items-center justify-center">
        ...
        >
          <img src={bgImg} alt="Circuit Board" className="w-full h-full object-cover" />
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter mb-6 md:mb-8 leading-[1.1] text-white text-center break-keep">
            {t('hero.t1')} <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 drop-shadow-[0_0_15px_rgba(129,140,248,0.5)]">
              {t('hero.t2')}
            </span>
          </h1>
