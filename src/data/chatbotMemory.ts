...
const PRODUCTS: MemoryEntry[] = [
  {
    ...
    answer:
      ...
      '🏠 가전 — 냉장고 Display PCB, 얼음정수기 제어보드, 레인지후드, 공기청정기\n' +
      '🏭 산업용 — 식기세척기, 온도제어기, 펌프, 회의부스(1인/회의룸)\n' +
      '🏥 의료기기 — 원심분리기, 진단기, 치과 스케일러\n' +
      '☀️ 신재생에너지 — 태양광, 수소, 리튬이온, 연료전지',
    updatedAt: '2026-05-27',
  },
  {
    id: 'mainctrl',
  ...
  },
  {
    ...
    answer:
      '신재생에너지 라인업:\n• 태양광 패널 제어 — MPPT 효율 98.5%\n• 수소 시스템 제어 — 누출/압력/온도 다중 감지\n• 리튬이온 BMS — 최대 16S 셀 모니터링\n• 연료전지 제어 (PEMFC/SOFC) — 1~100kW',
    updatedAt: '2026-05-27',
  },
];
